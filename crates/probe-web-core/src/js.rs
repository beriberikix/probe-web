...
//! these settings, which the TypeScript wire types generated by `tools/wire-gen`
//! (`packages/client/src/wire.ts`) assume: externally tagged enums, u64/i64 as `bigint`,
